...
\renewtcolorbox{Shaded}{
    ...
    arc=0.5em,
    auto outer arc,
interior style={fill tile image*={height=64pt}{/nix/store/0japjbcx259wld5919pwfavxisbfsavr-copperflame/assets/acrylic-texture.png}},
...
\newfontfamily{\dosfont}{less-perfect-dos-vga}[
    Path = /nix/store/kk8agc06yclp5aw3g8b2a235p0f4r9js-perfect-dos-vga/share/fonts/truetype/,
    Extension = .ttf,
    NFSSFamily=dosfont,
    Scale=1.2
]
